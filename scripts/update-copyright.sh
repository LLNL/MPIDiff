...
# "the MPIDiff LICENSE file", which is part of the copyright statement at the
# top of each MPIDiff file. We use this to distinguish MPIDiff files from ones
...
#=============================================================================
grep -rl "the MPIDiff LICENSE file" . --exclude-dir=.git --exclude-dir=tpl --exclude-dir=build* --exclude=update-copyright.sh > files2change
